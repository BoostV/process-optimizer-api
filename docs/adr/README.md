...
agent-generated plans and specs produced while building (e.g. under
`docs/superpowers/`) may live on the branch for review, but are removed in a
cleanup commit before merge (see `AGENTS.md`).
